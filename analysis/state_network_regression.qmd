...
state_matrices <- array(NA, c(9, length(contiguity[1,]),length(contiguity[1,]))) 
...
state_matrices[7,,] <- gov_gender
state_matrices[8,,] <- gov_age
state_matrices[9,,] <- gov_party
...
state_model$names <- c("Intercept", "Contiguity", "Ideology", "White", "Black", "Twitter", "Urban", "Governor Gender", "Governor Age", "Governor Party")

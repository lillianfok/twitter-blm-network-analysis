...
```{r, echo = FALSE, fig.cap = "Police refrom laws passed by state"}
library(usmap)
plot_usmap(data = state_info, values = "bill_score", color = "red") + 
  scale_fill_continuous(
    low = "white", high = "red", name = "Police Reform Laws passed", label = scales::comma
